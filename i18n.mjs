...
export const messages = [
  ...
  ['RDP 1 晶片連線後會自動清除全部 Flash（含最後 4 KB）並解除保護', 'Connecting an RDP 1 device automatically removes protection and erases all Flash, including the last 4 KB'],
  ...
  ['RDP 1 降回 0 會清除 Flash，包含最後 4 KB', 'RDP 1 → 0 erases Flash, including the last 4 KB'],
